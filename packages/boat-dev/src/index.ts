/**
 * @rikalabs/distilled-boat-dev — Boat SDK for Effect.
 *
 ...
 *
 * const { sandboxes } = yield* Boat.Services.boat.listSandboxes({});
 * ```
 */
...
export * from "./services/boat.ts";
export { BadRequest, Conflict, Forbidden, NotFound } from "./services/boat.ts";
