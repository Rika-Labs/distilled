...
export const DeleteAiGatewayVirtualModelConfigBySlugRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "DELETE",
        uri: "/v1/ai-gateway/virtual-model-configs/{vmcSlug}",
        code: 200,
      }),
    ),
  ).annotate({
...
export const DeleteAiGatewayVirtualModelConfigBySlugResponse =
  /*@__PURE__*/ S.suspend(() => S.Unknown.pipe(T.RawResponseRoot())).annotate({
...
export const GetAiGatewayVirtualModelConfigBySlugRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      vmcSlug: S.String.pipe(T.Label()),
      ownerId: S.optional(S.String.pipe(T.Query())),
...
export const UpdateAiGatewayVirtualModelConfigBySlugRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      vmcSlug: S.String.pipe(T.Label()),
      teamId: S.optional(S.String.pipe(T.Query())),
