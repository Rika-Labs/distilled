...
export const BuyCreditsResponseBodyCase1PurchaseIntentConfigurationCase3Options =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      orbSubscriptionId: S.String,
      add: S.optional(
        BuyCreditsResponseBodyCase1PurchaseIntentConfigurationCase3OptionsAddList,
      ),
      ...
      edit: S.optional(
        BuyCreditsResponseBodyCase1PurchaseIntentConfigurationCase3OptionsEditList,
      ),
    ...
    identifier:
      "BuyCreditsResponseBodyCase1PurchaseIntentConfigurationCase3Options",
